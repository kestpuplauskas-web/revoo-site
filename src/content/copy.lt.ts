...
export const lt: Copy = {
  ...
  pricing: {
    ...
    badges: [
      "Nuo 79 € per mėnesį",
      "Be avanso už licencijas",
      "Be ilgalaikės sutarties",
      "Be procento nuo rezervacijų",
    ],
    step1: "1. KOKIA NUOMA",
    shortTitle: "Trumpalaikė nuoma",
    shortSub: "Viešbučiai, apartamentai, nameliai, svečių namai",
    longTitle: "Ilgalaikė nuoma",
    longSub: "Butai ir patalpos pagal mėnesines sutartis",
    step2: "2. KIEK VIENETŲ",
    unitsLabel: "Kambarių ar apartamentų skaičius",
    unitsHint: "Viešbučio kambariai, apartamentai, nameliai — viskas, kas nuomojama paromis.",
    totalLabel: "Jūsų mėnesinė kaina",
    perMonth: "per mėnesį",
