...
export const en: Copy = {
  ...
  pricing: {
    eyebrow: "PRICING",
    h2: "You pay for *units*, not for modules",
    lede: "One monthly subscription for the whole system. The price depends only on how many rooms or apartments you have. No per-seat fees, no licence costs, no server rental.",
    badges: [
      "From €79 per month",
    ...
    step1: "1. TYPE OF RENTAL",
    shortTitle: "Short-term rental",
    shortSub: "Hotels, apartments, cabins, guesthouses",
    longTitle: "Long-term rental",
    longSub: "Flats and premises on monthly contracts",
    step2: "2. HOW MANY UNITS",
    unitsLabel: "Number of rooms or apartments",
    unitsHint: "Hotel rooms, apartments, cabins — everything you rent by the night.",
    totalLabel: "Your monthly price",
    perMonth: "per month",
